...
export default class MediumField extends Component {
  ...
  render() {
    return (
      <div
        className="data-field flex w-full items-center border-t border-solid bg-white border-gray-300 dark:border-gray-700 lg:h-32 md:h-28 h-32 cursor-pointer relative"
