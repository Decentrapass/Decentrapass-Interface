    ...
    return (
      <div className="w-full flex items-center justify-center text-gray-200 py-16 bg-green-1000 dark:bg-gray-800">
        <div className="w-4/5 2xl:w-3/5 flex flex-col items-center justify-center font-sans">
          ...
          <div className="flex w-full justify-center items-start mt-20 mb-24">
            <div className="flex-col items-center justify-start text-center w-1/3">
              <img src={Eth} className="w-2/3 block m-auto mb-8" />
            ...
            <div className="flex-col items-center justify-start text-center mx-7 w-1/3">
              <img src={Decetralized} className="w-2/3 block m-auto mb-8" />
            ...
            <div className="flex-col items-center justify-start text-center w-1/3">
              <img src={Time} className="w-2/3 block m-auto mb-8" />
          ...
          <div className="w-full flex flex-col items-center justify-center">
            ...
            <Link
              to="docs/token"
              className="transition-colors border-2 border-solid border-white rounded-full py-3 px-5 text-lg hover:bg-gray-900 hover:text-green-400 hover:border-green-400 dark:hover:bg-gray-900 dark:hover:text-green-500 dark:hover:border-green-500"
            >
              Discover SAFE
            </Link>
          </div>
